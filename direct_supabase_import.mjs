...
async function importData() {
    ...
    // Get users via regular query since admin API might not be available
    ...
    if (authUsers) {
        // Link Ben Howard
        const benUser = authUsers.find(u => 
        ...
        // Link Tom Donlan
        const tomUser = authUsers.find(u => 
            u.raw_user_meta_data?.full_name === 'Tom Donlan'
        );
